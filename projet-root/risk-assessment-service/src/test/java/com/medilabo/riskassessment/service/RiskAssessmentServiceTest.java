...
class RiskAssessmentServiceTest {
    ...
    // Patient API : déjà avec le trailing slash, on garde tel quel
    private static final String P = "http://gateway-service:8080/api/patients/";
    // NOTE API BASE = /api/notes/ (sans /patient ici)
    private static final String N = "http://gateway-service:8080/api/notes/";

    @BeforeEach
    void setup() {
        restTemplate = mock(RestTemplate.class);
        // On passe bien la base patients ET la base notes (sans /patient)
    ...
    void shouldReturnNoneWhenNoTriggerAndAgeAbove30() {
        ...
        when(restTemplate.getForObject(N + "patient/1", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldReturnEarlyOnsetForManUnder30With5Triggers() {
        ...
        when(restTemplate.getForObject(N + "patient/2", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldReturnDetailedAssessment() {
        ...
        when(restTemplate.getForObject(N + "patient/3", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldReturnNoneForOneTriggerAbove30() {
        ...
        when(restTemplate.getForObject(N + "patient/4", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldReturnInDangerAbove30With6Triggers() {
        ...
        when(restTemplate.getForObject(N + "patient/5", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldReturnEarlyOnsetAbove30With8Triggers() {
        ...
        when(restTemplate.getForObject(N + "patient/6", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldHandleMaleExactly30Thresholds() {
        ...
        when(restTemplate.getForObject(N + "patient/7", NoteDTO[].class)).thenReturn(n3);
        ...
        when(restTemplate.getForObject(N + "patient/8", NoteDTO[].class)).thenReturn(n5);
    ...
    void shouldHandleFemaleExactly30Thresholds() {
        ...
        when(restTemplate.getForObject(N + "patient/9", NoteDTO[].class)).thenReturn(n4);
        ...
        when(restTemplate.getForObject(N + "patient/10", NoteDTO[].class)).thenReturn(n7);
    ...
    void shouldHandleMaleUnder30AllPaths() {
        ...
        when(restTemplate.getForObject(N + "patient/11", NoteDTO[].class)).thenReturn(n2);
        ...
        when(restTemplate.getForObject(N + "patient/12", NoteDTO[].class)).thenReturn(n3);
        ...
        when(restTemplate.getForObject(N + "patient/13", NoteDTO[].class)).thenReturn(n5);
    ...
    void shouldHandleFemaleUnder30AllPaths() {
        ...
        when(restTemplate.getForObject(N + "patient/14", NoteDTO[].class)).thenReturn(n3);
        ...
        when(restTemplate.getForObject(N + "patient/15", NoteDTO[].class)).thenReturn(n6);
        ...
        when(restTemplate.getForObject(N + "patient/16", NoteDTO[].class)).thenReturn(n7);
    ...
    void shouldReturnNoneForUnknownGenderUnder30EvenWithManyTriggers() {
        ...
        when(restTemplate.getForObject(N + "patient/17", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldHandleNullNotesAsNone() {
        ...
        when(restTemplate.getForObject(N + "patient/18", NoteDTO[].class)).thenReturn(null);
    ...
    void shouldIgnoreNullContentNote() {
        ...
        when(restTemplate.getForObject(N + "patient/19", NoteDTO[].class)).thenReturn(notes);
    ...
    void shouldCallExpectedEndpoints() {
        ...
        when(restTemplate.getForObject(eq(N + "patient/20"), eq(NoteDTO[].class))).thenReturn(notes);

        service.assessRisk(20L);

        verify(restTemplate).getForObject(P + "20", PatientDTO.class);
        verify(restTemplate).getForObject(N + "patient/20", NoteDTO[].class);
